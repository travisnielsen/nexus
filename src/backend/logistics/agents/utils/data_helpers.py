...
current_active_filter: ContextVar[dict[str, Any] | None] = ContextVar(
    "current_active_filter", default=None
)
...
current_selected_flight: ContextVar[dict[str, Any] | None] = ContextVar(
    "current_selected_flight", default=None
)
