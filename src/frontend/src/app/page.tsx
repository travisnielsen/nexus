...
// (RecommendationsCard implementation lives in components/RecommendationsCard.tsx)
// Keep the prop type here for the useRenderToolCall handler signature.
...
function LogisticsDashboard({ themeColor }: { themeColor: string }) {
  ...
  const { appendMessage } = useCopilotChatInternal();
